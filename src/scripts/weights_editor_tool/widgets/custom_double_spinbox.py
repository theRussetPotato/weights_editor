...
class CustomDoubleSpinBoxLineEdit(QtWidgets.QLineEdit):
    """
    A line edit specifically for the CustomDoubleSpinBox, to replace its default line edit with.
...
class CustomDoubleSpinBox(QtWidgets.QDoubleSpinBox):
    ...
    Args:
        ...
        minValue (float, optional): The spinbox's minimum value.
        maxValue (float, optional): The spinbox's maximum value.
    ...
    def __init__(
            ...
            singleStep: Optional[float] = None,
        ...
        self._lineEdit = CustomDoubleSpinBoxLineEdit(toolTip, parent=self)
        self._toolTip = toolTip
        self._label = None
